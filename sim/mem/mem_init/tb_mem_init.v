...
module tb_mem_init;
    ...
    task create_test_firmware;
        ...
        begin
            ...
            $fclose(file);
            $display("Created test firmware file with %d entries", IMEM_DEPTH);
        end
    endtask
    ...
    task test_init_sequence;
        ...
        begin
            ...
            for (i = 0; i < IMEM_DEPTH; i = i + 1) begin  // Check All IMEM
    ...
    task read_imem;
        ...
        begin
            ...
            data = imem_inst.imem_inst.mem[addr[$clog2(IMEM_DEPTH)+1:2]];  // Direct memory access
        end
    endtask
    ...
    task read_dmem;
        ...
        begin
            ...
            data = dmem_inst.dmem_inst.mem[addr[$clog2(DMEM_DEPTH)+1:2]];  // Direct memory access
        end
    endtask
